    ...
    <div class="portlet">
        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-md-6">
                        @if(in_array('ADD',Session::get('userinfo')->permission['page_11']['actions']))
                            <div class="btn-group">
                                <a href="{{url('/master/insurer-add')}}" id="" class="btn btn-success">
                                <i class="fa fa-plus"></i> Add Insurer
                                </a>
                            </div>
                        @endif
            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="tb-insurer">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Thumbnail</th>
...
<script>
    jQuery(document).ready(function() {   
        var ajTable = jQuery("#tb-insurer").dataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
                "url": "{{url('/datatable/insurer')}}",
                "type": "POST",
                "data": function ( d ) {
    ...
    function reloadTable(){
        $('#tb-insurer').DataTable().ajax.reload();
    }
