    ...
    <div class="portlet">
        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-md-6">
                    @if(in_array('ADD',Session::get('userinfo')->permission['page_3']['actions']))
                        <div class="btn-group">
            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="tb-homecat">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Thumbnail</th>
...
<script>
    jQuery(document).ready(function() {   
        var ajTable = jQuery("#tb-homecat").dataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
                "url": "{{url('/datatable/homecat')}}",
                "type": "POST",
                "data": function ( d ) {
    ...
    function reloadTable(){
        $('#tb-homecat').DataTable().ajax.reload();
    }
