    ...
    <div class="portlet">
        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-md-6">
                    @if(in_array('ADD',Session::get('userinfo')->permission['page_8']['actions']))
                        <div class="btn-group">
                            <a href="{{url('/promotion-add')}}" id="" class="btn btn-success">
            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="tb-promotion">
                    <thead>
                        <tr>
                            <th>No</th>
...
<script>
    jQuery(document).ready(function() {   
        var ajTable = jQuery("#tb-promotion").dataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
                "url": "{{url('/datatable/promotion')}}",
                "type": "POST",
                "data": function ( d ) {
    ...
    function reloadTable(){
        $('#tb-promotion').DataTable().ajax.reload();
    }
    function setActive(action,code){
        if(confirm("Are you sure to change status this item ?")){
            ...
            $.ajax({
                url: "{{url('/action/promotion-status')}}",
                type: "POST",
                data: params,
