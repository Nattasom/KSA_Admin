...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="#">เพิ่ม {{$resp["detail"]["th"]["title"]}}</a>
            </li>
        </ul>
    </div>
    <div class="portlet">
        ...
        <div class="portlet-body form">
            <form action="" id="form-content" class="form-horizontal" method="post" enctype="multipart/form-data">
                <div class="form-body">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane {{($key==0) ? 'active':''}}" id="tab_{{$key}}">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="content_title_{{$value->LanguageCode}}" value="{{$resp['detail'][$value->LanguageCode]['title']}}"  placeholder="Title">
                                </div>
                            </div>
                            <!-- <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea class="ckeditor form-control" name="editor_{{$value->LanguageCode}}" rows="6">{{$resp['detail'][$value->LanguageCode]['desc']}}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 350px; height: 150px;">
                                         @if(!empty($resp['detail'][$value->LanguageCode]['thumbnail']))
                                            <img src="{{Config::get('app.root_path')}}/uploads/content/{{$resp['detail'][$value->LanguageCode]['thumbnail']}}" />
                                        @endif
                                        </div>
                                        <div>
                    ...
                    <input type="hidden" name="content_id" value="{{$resp['id']}}" />
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select name="content_status" id="" class="form-control">
                                ...
                                <option value="A" {{($resp['content_status']=='A') ? 'selected':''}}>Active</option>
                                <option value="I" {{($resp['content_status']=='I') ? 'selected':''}}>Inactive</option>
                            </select>
                        </div>
                    </div>
                </div>
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            <input type="hidden" name="action_url" value="{{url('/action/content-edit')}}" id="hd-action-url" />
