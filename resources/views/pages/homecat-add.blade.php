                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane {{($key==0) ? 'active':''}}" id="tab_{{$key}}">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="cat_name_{{$value->LanguageCode}}"  placeholder="Name">
                                </div>
                            </div>
                        </div>
                        @endforeach
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            <input type="hidden" name="action_url" value="{{url('/action/homecat-add')}}" id="hd-action-url" />
